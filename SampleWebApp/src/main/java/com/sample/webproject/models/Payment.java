...
public class Payment {
    ...
    private List<OrderAndFood> payment = new ArrayList<OrderAndFood>();

    public Payment() {
 
    }
    
    public Payment(String id, Tables table_id, int total, Staff staff) {
        this.id = id;
     ...
     */
    public List<OrderAndFood> getPayment() {
        return payment;
    }
     ...
     */
    public void setPayment(List<OrderAndFood> payment) {
